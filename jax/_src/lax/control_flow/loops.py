...
physical.physicalize_rules[scan_p] = _scan_physicalize_rule
...
def _while_physicalize_rule(_,
  ...
  return while_p.bind(*args,
                      cond_jaxpr=physical.physicalize_jaxpr(cond_jaxpr),
                      body_jaxpr=physical.physicalize_jaxpr(body_jaxpr),
                      cond_nconsts=cond_nconsts,
...
physical.physicalize_rules[while_p] = _while_physicalize_rule
