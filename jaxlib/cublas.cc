...
/*static*/ absl::StatusOr<BlasHandlePool::Handle> BlasHandlePool::Borrow(
  ...
  if (pool->handles_[stream].empty()) {
    JAX_RETURN_IF_ERROR(cublasCreate(&handle));
  } else {
    handle = pool->handles_[stream].back();
    pool->handles_[stream].pop_back();
  }
  if (stream) {
    JAX_RETURN_IF_ERROR(cublasSetStream(handle, stream));
  }
...
absl::Status TrsmBatched_(cudaStream_t stream, void** buffers,
  ...
  switch (d.type) {
    case Type::F32: {
      ...
      JAX_RETURN_IF_ERROR(cublasStrsmBatched(
    ...
    case Type::F64: {
      ...
      JAX_RETURN_IF_ERROR(cublasDtrsmBatched(
          handle->get(), d.side, d.uplo, d.trans, d.diag, d.m, d.n, &alpha,
    ...
    case Type::C64: {
      ...
      JAX_RETURN_IF_ERROR(cublasCtrsmBatched(
          handle->get(), d.side, d.uplo, d.trans, d.diag, d.m, d.n, &alpha,
    ...
    case Type::C128: {
      ...
      JAX_RETURN_IF_ERROR(cublasZtrsmBatched(
          handle->get(), d.side, d.uplo, d.trans, d.diag, d.m, d.n, &alpha,
...
absl::Status GetrfBatched_(cudaStream_t stream, void** buffers,
  ...
  switch (d.type) {
    case Type::F32: {
      ...
      JAX_RETURN_IF_ERROR(cublasSgetrfBatched(handle->get(), d.n, batch_ptrs,
                                              d.n, ipiv, info, d.batch));
      break;
    }
    case Type::F64: {
      double* a = static_cast<double*>(buffers[1]);
      double** batch_ptrs = static_cast<double**>(buffers[4]);
      JAX_RETURN_IF_ERROR(cublasDgetrfBatched(handle->get(), d.n, batch_ptrs,
                                              d.n, ipiv, info, d.batch));
      break;
    }
    case Type::C64: {
      ...
      JAX_RETURN_IF_ERROR(cublasCgetrfBatched(handle->get(), d.n, batch_ptrs,
                                              d.n, ipiv, info, d.batch));
      break;
    }
    case Type::C128: {
      ...
      JAX_RETURN_IF_ERROR(cublasZgetrfBatched(handle->get(), d.n, batch_ptrs,
                                              d.n, ipiv, info, d.batch));
      break;
    }
  }
