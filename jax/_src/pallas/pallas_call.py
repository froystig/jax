...
def _pallas_call_physicalize_rule(ctx: physical.PhysicalizeContext,
                                  *args,
                                  jaxpr: jax_core.Jaxpr,
                                  grid_mapping: GridMapping,
                                  **kwargs
  ...
  del ctx
  closed_jaxpr = pe.close_jaxpr(jaxpr)
  physical_jaxpr = physical.physicalize_jaxpr(closed_jaxpr)
  new_block_mappings = []
  for i, bm in enumerate(grid_mapping.block_mappings):
    inner_aval = bm.block_aval.inner_aval
    if physical.is_extended(inner_aval):
...
physical.physicalize_rules[pallas_call_p] = _pallas_call_physicalize_rule
