...
def _cond_physicalize_rule(ctx: physical.PhysicalizeContext,
                           index, *args, branches):
  del ctx
  physical_branches = map(physical.physicalize_jaxpr,
                          branches)
...
physical.physicalize_rules[cond_p] = _cond_physicalize_rule
